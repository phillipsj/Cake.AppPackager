...
namespace Cake.AppPackager.Encrypt {
    /// <summary>
    /// The App Packager encrypter used to encrypt packages.
    /// </summary>
    public sealed class AppEncrypter : AppPackagerTool<AppPackagerSettings> {
        private readonly ICakeEnvironment _environment;

        /// <summary>
        /// Initializes a new instance of the <see cref="AppEncrypter"/> class.
        /// </summary>
        ...
        public AppEncrypter(IFileSystem fileSystem,
